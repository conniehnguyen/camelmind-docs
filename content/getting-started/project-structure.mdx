...
| Goal | Where to go |
|---|---|
| Write and organize pages | [Writing Content](/guides/writing-docs) |
| Use Callout, Steps, Tabs, and more | [MDX Components](/guides/mdx-components) |
| Change the sidebar and URLs | [Navigation](/guides/navigation) |
