...
## Deploy your CamelMind site to Vercel

Follow these steps to build, configure, and deploy your CamelMind site to Vercel:
...
See [Environment Variables](/deployment/environment-variables) for the complete list of supported variables.
...
## Use a custom domain on Vercel

To set up a custom domain for your Vercel deployment, follow these steps:
...
## Preview deployments for pull requests on Vercel

When you create or update a pull request, Vercel automatically builds and assigns a unique preview deployment URL to test your CamelMind changes.

---

## Troubleshooting Vercel deployments

If you encounter issues when deploying your site to Vercel, refer to these common troubleshooting solutions:
