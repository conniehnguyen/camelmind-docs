...
| ----------------------- | --------------------------------------------------------------------------- |
| `/llms.txt` | Plain-text version of your documentation for AI assistants and developers. If your site has multiple versions, each version has its own index at `/{version}/llms.txt` (for example, `/v2/llms.txt`), generated from that version's `nav.yml`. |
